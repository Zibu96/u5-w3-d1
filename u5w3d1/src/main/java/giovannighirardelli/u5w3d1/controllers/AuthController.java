package giovannighirardelli.u5w3d1.controllers;


import giovannighirardelli.u5w3d1.exceptions.BadRequestException;
import giovannighirardelli.u5w3d1.payloads.DipendenteLoginDTO;
import giovannighirardelli.u5w3d1.payloads.DipendenteLoginResponseDTO;
import giovannighirardelli.u5w3d1.payloads.NewDipendentiDTO;
import giovannighirardelli.u5w3d1.payloads.NewDipendentiResponseDTO;
import giovannighirardelli.u5w3d1.servicies.AuthService;
import giovannighirardelli.u5w3d1.servicies.DipendentiService;
